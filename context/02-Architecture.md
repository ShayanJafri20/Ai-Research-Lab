...
| Backend | FastAPI (`lab/main.py`), raw `http.server` kept as reference (`lab/server.py`) | V0.3-V0.5 complete — three routes, decorator routing, auto JSON, CORS configured, real DB-backed persistence, `get_connection()` refactor done (2026-08-27). Next: V0.6 (SQL/migrations/indexes) — see [[08-Next-Step]] |
